...
import { clamp, rand } from '../engine/utils.js?v=1785964069';
...
import { Enemy } from './enemy.js?v=1785964069';
import { Boss } from './boss.js?v=1785964069';
import { MONSTER_MAP } from '../data/monsters.js?v=1785964069';
import { BOSS_MAP } from '../data/bosses.js?v=1785964069';
import { shade } from '../engine/sprite.js?v=1785964069';
...
export class Level {
  ...
  spawnProjectile(src, kind, opt = {}) {
    ...
    this.projectiles.push({
      ...
      vy: (opt.vyOff || 0) + (d.vy ?? (kind === 'arrow' ? rand(-20, 20) : 0)),
